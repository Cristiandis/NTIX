...
* **Colors**: Output is color-coded — green for install, orange for upgrade, dark red for remove. Package managers are colored: purple for winget, blue for chocolatey, pink for scoop.
